  ...
  return (
    <div className={`drawer ${isDrawerOpen ? "drawer-open" : ""} drawer-mobile lg:drawer-open bg-gradient-to-r from-[#452424] to-[#202020]`}>
      ...
      <div className="drawer-content flex flex-col">
        <h1 className="font-serif text-3xl text-white p-4 text-center mt-6">Welcome <span className="text-orange-500">{user.displayName} </span>to Cross Site Scripting Detection & Prevention Methods.</h1>
        <Outlet />
      ...
      <div className="drawer-side">
        ...
        <ul className="bg-gradient-to-r from-[#452424] to-[#202020] menu p-4 w-80 bg-base-200 text-base-content flex flex-col justify-between h-full">
          <div>
            <Link to="xss_methods" onClick={handleLinkClick}>
            ...
            <Link to="xss_detection" onClick={handleLinkClick}>
